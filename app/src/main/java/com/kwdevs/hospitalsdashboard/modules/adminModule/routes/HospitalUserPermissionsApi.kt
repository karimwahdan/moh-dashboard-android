...
interface HospitalUserPermissionsApi {

    @POST("$CONTROL_PREFIX/hospital-user/permissions/store")
    suspend fun storePermission(@Body body: PermissionBody):SinglePermissionResponse

    @POST("$CONTROL_PREFIX/hospital-user/permissions/update")
    suspend fun updatePermission(@Body body: PermissionBody):SinglePermissionResponse

    @POST("$CONTROL_PREFIX/hospital-user/roles/store")
    suspend fun storeHospitalUserRole(@Body roleBody: RoleBody):RoleSingleResponse
    @POST("$CONTROL_PREFIX/hospital-user/roles/update")
    suspend fun updateHospitalUserRole(@Body roleBody: RoleBody):RoleSingleResponse
