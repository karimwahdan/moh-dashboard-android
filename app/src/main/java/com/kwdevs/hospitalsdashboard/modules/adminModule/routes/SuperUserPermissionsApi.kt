...
interface SuperUserPermissionsApi {

    @POST("$CONTROL_PREFIX/super-user/roles/store")
    suspend fun storeSuperUserRole(@Body roleBody: RoleBody):RoleSingleResponse

    @POST("$CONTROL_PREFIX/super-user/roles/update")
    suspend fun updateSuperUserRole(@Body roleBody: RoleBody):RoleSingleResponse

    @POST("$CONTROL_PREFIX/super-user/permissions/store")
    suspend fun storePermission(@Body body: PermissionBody):SinglePermissionResponse

    @POST("$CONTROL_PREFIX/super-user/permissions/update")
