    ...
    items.forEach { (time, items) ->
        ...
        Row(modifier=Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically){
            Column(modifier=Modifier.border(width = 1.dp, color = GRAY),verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally){
                ...
                Box(modifier=Modifier.padding(horizontal = 5.dp), contentAlignment = Alignment.Center){ Label(STRATEGIC_LABEL, fontSize = 13, maximumLines = 3) }
                VerticalSpacer(5)

            }
            /*
               Column(modifier=Modifier.border(width = 1.dp, color = GRAY),verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally){
                Box(modifier=Modifier.padding(horizontal = 5.dp),contentAlignment = Alignment.Center){ Label(UNDER_INSPECTION_LABEL, fontSize = 12) }
                VerticalSpacer(13)
                Box(modifier=Modifier.padding(horizontal = 5.dp),contentAlignment = Alignment.Center){ Span("$underInspectionCount", backgroundColor = if(underInspectionCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
                VerticalSpacer(14)
            }
             */
            LazyRow(modifier=Modifier.fillMaxWidth().weight(1f), verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.Start){
                item{
                    Column(modifier=Modifier.border(width = 1.dp, color = GRAY),verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally){
                        ...
                        HorizontalDivider()
                        VerticalSpacer(2)
                        Box(modifier=Modifier.padding(horizontal = 5.dp),contentAlignment = Alignment.Center){ Span("$aPosStrategicCount", backgroundColor = if(aPosStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
                        VerticalSpacer(2)
                    ...
                    Column(modifier=Modifier.border(width = 1.dp, color = GRAY),verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally){
                        ...
                        HorizontalDivider()
                        VerticalSpacer(2)
                        Box(modifier=Modifier.padding(horizontal = 5.dp),contentAlignment = Alignment.Center){ Span("$aNegStrategicCount", backgroundColor = if(aNegStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
                        VerticalSpacer(2)
                    ...
                    Column(modifier=Modifier.border(width = 1.dp, color = GRAY),verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally){
                        ...
                        HorizontalDivider()
                        VerticalSpacer(2)
                        Box(modifier=Modifier.padding(horizontal = 5.dp),contentAlignment = Alignment.Center){ Span("$bPosStrategicCount", backgroundColor = if(bPosStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
                        VerticalSpacer(2)
                    ...
                    Column(modifier=Modifier.border(width = 1.dp, color = GRAY),verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally){
                        ...
                        HorizontalDivider()
                        VerticalSpacer(2)
                        Box(modifier=Modifier.padding(horizontal = 5.dp), contentAlignment = Alignment.Center){ Span("$bNegStrategicCount", backgroundColor = if(bNegStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
                        VerticalSpacer(2)
                    ...
                    Column(modifier=Modifier.border(width = 1.dp, color = GRAY),verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally){
                        ...
                        HorizontalDivider()
                        VerticalSpacer(2)
                        Box(modifier=Modifier.padding(horizontal = 5.dp),contentAlignment = Alignment.Center){ Span("$oPosStrategicCount", backgroundColor = if(oPosStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
                        VerticalSpacer(2)
                    ...
                    Column(modifier=Modifier.border(width = 1.dp, color = GRAY),verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally){
                        ...
                        HorizontalDivider()
                        VerticalSpacer(2)
                        Box(modifier=Modifier.padding(horizontal = 5.dp),contentAlignment = Alignment.Center){ Span("$oNegStrategicCount", backgroundColor = if(oNegStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
                        VerticalSpacer(2)
                    ...
                    Column(modifier=Modifier.border(width = 1.dp, color = GRAY),verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally){
                        ...
                        VerticalSpacer(2)
                        HorizontalDivider()
                        Box(modifier=Modifier.padding(horizontal = 5.dp),contentAlignment = Alignment.Center){ Span("$aBPosStrategicCount", backgroundColor = if(aBPosStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
                        VerticalSpacer(2)
                    ...
                    Column(modifier=Modifier.border(width = 1.dp, color = GRAY),verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally){
                        ...
                        VerticalSpacer(2)
                        HorizontalDivider()
                        Box(modifier=Modifier.padding(horizontal = 5.dp),contentAlignment = Alignment.Center){ Span("$aBNegStrategicCount", backgroundColor = if(aBNegStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
                        VerticalSpacer(2)
        ...
        Row(modifier=Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center, verticalAlignment = Alignment.CenterVertically){
            ...
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$aPosCount", backgroundColor = if(aPosCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$aNegCount", backgroundColor = if(aNegCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$bPosCount", backgroundColor = if(bPosCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$bNegCount", backgroundColor = if(bNegCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$oPosCount", backgroundColor = if(oPosCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$oNegCount", backgroundColor = if(oNegCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$aBPosCount", backgroundColor = if(aBPosCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$aBNegCount", backgroundColor = if(aBNegCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
        }
        Row(modifier=Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center, verticalAlignment = Alignment.CenterVertically){
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1.5f), contentAlignment = Alignment.Center){ Label(STRATEGIC_LABEL, fontSize = 13, maximumLines = 3) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$aPosStrategicCount", backgroundColor = if(aPosStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$aNegStrategicCount", backgroundColor = if(aNegStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$bPosStrategicCount", backgroundColor = if(bPosStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$bNegStrategicCount", backgroundColor = if(bNegStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$oPosStrategicCount", backgroundColor = if(oPosStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$oNegStrategicCount", backgroundColor = if(oNegStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$aBPosStrategicCount", backgroundColor = if(aBPosStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
            Box(modifier=Modifier.fillMaxWidth().border(width = 1.dp, color = GRAY).weight(1f), contentAlignment = Alignment.Center){ Span("$aBNegStrategicCount", backgroundColor = if(aBNegStrategicCount>0)BLUE else Color.Red, color = WHITE, fontSize = 16) }
        }
