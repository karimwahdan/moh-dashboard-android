...
@Composable
fun CurativeBloodBankKpiSection(controller:HomeController){
    val context       = LocalContext.current
    val kpiBody       =  remember { mutableStateOf<KpiFilterBody?>(null) }
    val state         by controller.curativeKpiState.observeAsState()
    ...
    val exportState by issuingDepartmentController.curativeExcelState.observeAsState()
    ...
    val excelFileName       = remember { mutableStateOf("curative_kpis") }
            ...
            ColumnContainer {
                ...
                CustomButton(label = SAVE_CHANGES_LABEL,
                    ...
                    if(excelFileName.value!= EMPTY_STRING){
                        val b=kpiBody.value
                        b?.let{
                            issuingDepartmentController.saveKpiExcelFile(KpiType.CURATIVE,it)
                        }
                    }
            ...
            ColumnContainer {
                ...
                Row(modifier=Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center){
                    CustomButton(label="Filter",
                        ...
                        kpiBody.value?.let {controller.getCurativeCharts(it)}
