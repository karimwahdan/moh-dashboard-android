package com.kwdevs.hospitalsdashboard.modules.bloodBankModule.subModules.kpis.views.cards
...
fun KpiCard(item: BloodBankKpi){
    ...
    ColumnContainer {
        Row(modifier=Modifier.fillMaxWidth(),
            ...
            Span(" $value ", backgroundColor = BLUE, color = WHITE, paddingStart = 5, paddingEnd = 5)
        }
    }
}