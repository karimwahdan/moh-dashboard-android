                    ...
                    LazyColumn(modifier=Modifier.fillMaxSize().weight(1f).padding(5.dp)) {
                        item{
                            ...
                            if(collectionDate.value.trim()!= EMPTY_STRING){
                                ...
                                if(campaignCode.value!= EMPTY_STRING){
                                    Row(modifier=Modifier.fillMaxWidth().padding(5.dp)){
                                    ...
                                    if(selectedDonationType.value!=null && selectedCampaignType.value!=null){
                                        Row(modifier=Modifier.fillMaxWidth().padding(5.dp)){
                                        ...
                                        if(selectedBloodType.value!=null){
                                            ...
                                            CustomInput(value=numberOfDonations,label= UNITS_NUMBER_LABEL, keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
                                                onTextChange = {if(it.toIntOrNull()!=null)numberOfDonations.value=it else numberOfDonations.value=EMPTY_STRING})
                                            if(selectedDonationType.value?.id==2) CustomInput(value=apheresisDonors,label=APHERESIS_DONORS_LABEL, keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
                                                onTextChange = {if(it.toIntOrNull()!=null) apheresisDonors.value=it else apheresisDonors.value=EMPTY_STRING})
                                            if((selectedDonationType.value?.id==1 && numberOfDonations.value.toIntOrNull()!=null) || (numberOfDonations.value.toIntOrNull()!=null && selectedDonationType.value?.id==2 && apheresisDonors.value.toIntOrNull()!=null)){
                                                    ...
                                                    CustomButton(label= SAVE_CHANGES_LABEL, enabledBackgroundColor = GREEN,
                                                        ...
                                                        if(hasBloodType && hasDonationType && campaignCodeIsSet &&
                                                            ...
                                                            campaign= DailyBloodCollection(
                                                                ...
                                                                apheresisDonors = if(isApheresis && apheresisDonors.value.toIntOrNull()!=null) apheresisDonors.value.trim().toIntOrNull() else null ,
